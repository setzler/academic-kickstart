...
summary: "**Revised and resubmitted to <ins>*Econometrica*</ins> in May 2021.** </br>My presentations: [NBER Summer Institute (Labor Studies)](https://conference.nber.org/sched/SI20LS), Stanford ([SITE Labor Markets](https://economics.stanford.edu/events/site-2020/session-12-micro-and-macro-labor-markets)), MIT (joint [Applied Micro](https://economics.mit.edu/events/pospol) seminar in Dev, IO, Labor, and Trade), UChicago, UToronto/Bank of Canada"
