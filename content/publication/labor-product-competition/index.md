...
summary: "**First version: March 2020. This version: April 2022.** </br>My presentations: [NBER Summer Institute (Labor Studies)](https://conference.nber.org/sched/SI20LS), Stanford ([SITE Labor Markets](https://economics.stanford.edu/events/site-2020/session-12-micro-and-macro-labor-markets)), MIT ([Super Applied Micro](https://economics.mit.edu/events/pospol) seminar joint with Dev, IO, Labor, and Trade), UBC, CESifo (Labor), UChicago, Penn State, UToronto/Bank of Canada"
