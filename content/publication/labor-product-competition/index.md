...
summary: "**Revision requested by <ins>*Econometrica*</ins> in October 2020**. </br>My presentations: [NBER Summer Institute (Labor Studies)](https://conference.nber.org/sched/SI20LS), Stanford ([SITE Labor Markets](https://economics.stanford.edu/events/site-2020/session-12-micro-and-macro-labor-markets)), MIT (joint seminar in [Applied Micro](https://economics.mit.edu/events/pospol) and [Industrial Organization](https://economics.mit.edu/events/iowork)), Chicago, Toronto"
