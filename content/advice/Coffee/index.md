...
1. **Grind:** Grind coffee beans until you have about 25g of medium-coarse coffee. The granules should be visible like coarse sand mixed with sea salt. If your grinder allows you to select a number of cups that you are making, select 2 cups. Note that grinding coffee is messy and loud, so grind it at home and bring it to the office in a vacuum-sealed container. Grind it on the same day it will be brewed, as ground coffee quickly oxidizes.
2. **Heat:** Fill the kettle with water and heat it to 190 degrees. If you are in a hurry, 175 degrees is the lowest acceptable temperature. The highest acceptable temperature is 200 degrees.
3. **Fill:** Place the filter in the Clever dripper and set the Clever dripper on a table top. Fill it with the ground coffee. Pour in the water, wetting all of the coffee, until the water is about 2cm from spilling over the top of the filter. Because it uses immersion, the Clever dripper does not require any pouring skill -- just try to wet all of the coffee grounds while pouring.
4. **Wait:** Wait 3-4 minutes. If you wait more than 6 minutes, it starts to taste over-extracted and bitter.
...
The reason the coffee in my office smells so good is because I only buy African coffee, which smells like fruits instead of nuts. Single-origin African coffee is typically not available in stores, but you can order it from the best roasters using Mistobox:
...
I recommend starting with Tandem. Make sure to order single-origin coffee that is from Africa (most commonly from Ethiopia) in whole bean form (not ground).
